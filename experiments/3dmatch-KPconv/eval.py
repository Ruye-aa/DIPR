...
import torch
import numpy as np
from modules.geotransformer.eval_lgr import local_to_global_registration as lgr
...
def make_parser():
    ...
    parser.add_argument('--benchmark', default='3DMatch', help='test benchmark') # choices=['3DMatch', '3DLoMatch'], required=True
    parser.add_argument('--method', default='lgr', help='registration method')  
    parser.add_argument('--num_corr', type=int, default=500, help='number of correspondences for registration')
