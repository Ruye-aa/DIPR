...
_C.root_dir = os.path.dirname(os.path.dirname(os.path.dirname(_C.working_dir)))                
_C.exp_name = os.path.basename(_C.working_dir)                

_C.output_dir = os.path.join(_C.root_dir, 'output', '3DMatch')      # 3DLoMatch   
...
# data
_C.data = edict()         
_C.data.dataset_root = os.path.join(_C.root_dir, 'data', '3DMatch')   # 3DLoMatch   
