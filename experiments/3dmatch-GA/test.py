...
def make_parser():
    ...
    parser.add_argument('--snapshot', type=str, default='output/snapshot/epoch-10.pth.tar', help='load from snapshot')
    ...
    parser.add_argument('--stage_nums', type=int, default=4, help='iter nums')
    parser.add_argument('--classifier_threshold', type=float, default=200, help='classifier threshold nums')

    parser.add_argument('--epsilon', type=float, default=0.125, help='dbscan cluster parameter')
    parser.add_argument('--min_samples', type=int, default=3, help='dbscan cluster parameter')
    return parser
