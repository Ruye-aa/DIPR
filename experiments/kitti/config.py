...
_C.root_dir = os.path.dirname(os.path.dirname(_C.working_dir))            
_C.exp_name = os.path.basename(_C.working_dir)                

_C.output_dir = os.path.join(_C.root_dir, 'output', 'kitti')       
...
# data
_C.data = edict()                  
_C.data.dataset_root = os.path.join(_C.root_dir, 'data', 'Kitti')  
...
_C.model.epsilon = 0.5
_C.model.min_samples = 2
