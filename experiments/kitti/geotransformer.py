...
class GeoTransformer_global(nn.Module):
    ...
    def forward(self, ref_points_c, src_points_c, ref_points_f, src_points_f, transform, data_dict=None):
        ...
        # feats_list[0] = self.point_feats(feats_list[0])
        ...
        # 7.2 Generate batched node points & feats             # point_matching.py
        ...
        with torch.no_grad():
            ...
            output_dict['batch_indices'] = batch_indices
...
class GeoTransformer_local(nn.Module):
    ...
    def forward(self, ref_points_c, src_points_c, ref_points_f, src_points_f, transform, 
                    ref_feats_c, src_feats_c, ref_feats_f, src_feats_f, transform_dict=None):
