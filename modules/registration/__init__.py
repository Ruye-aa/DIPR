from modules.registration.matching import (
...
from modules.registration.metrics import (
...
from modules.registration.procrustes import weighted_procrustes, WeightedProcrustes