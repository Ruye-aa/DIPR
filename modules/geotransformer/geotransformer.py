...
from modules.ops import pairwise_distance
from modules.transformer import SinusoidalPositionalEmbedding, RPEConditionalTransformer, VanillaConditionalTransformer
...
class GeometricTransformer(nn.Module):
    def __init__(
        ...
        self.transformer = RPEConditionalTransformer(# VanillaConditionalTransformer(# 
    ...
    def forward(
        ...
        if ref_feats.shape[-1] == self.input_dim:
