...
from modules.registration.procrustes import WeightedProcrustes
...
class LocalGlobalRegistration(nn.Module):
    ...
    def local_to_global_registration(self, ref_knn_points, src_knn_points, score_mat, corr_mat):
        ...
        return global_ref_corr_points, global_src_corr_points, cur_corr_scores, estimated_transform         # global_corr_scores
    ...
    def forward(
        ...
        return ref_corr_points, src_corr_points, score_mat, corr_scores, estimated_transform, corr_mat
